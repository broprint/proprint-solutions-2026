  ...
  return <main>
    ...
    <section className="py-12"><div className="container"><div className="grid gap-10 lg:grid-cols-[1.05fr_.95fr]">
      ...
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">{canAddToCart && <AddToCartButton product={product}/>}<Link href={quoteHref} className="rounded-full bg-[#061321] px-6 py-3.5 font-black text-white">{inquiryLabel}</Link></div>
