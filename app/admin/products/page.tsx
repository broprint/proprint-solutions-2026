...
export default async function AdminProductsPage({ searchParams }: { searchParams: Promise<{ published?: string; unpublished?: string; error?: string }> }) {
  ...
  return <main className="min-h-[75vh] bg-slate-50 py-12"><div className="container">
    ...
    {params.error && <div className="mt-5 rounded-xl bg-red-50 px-4 py-3 text-sm font-bold text-red-700">The publishing status could not be changed. Please try again.</div>}
