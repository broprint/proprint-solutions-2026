...
export function ShopCatalog({ products, initialCategory = 'All' }: { products: Product[]; initialCategory?: string }) {
  ...
  return <>
    ...
    <section className="py-8 xl:py-10"><div className="mx-auto w-[calc(100%-48px)]"><div className="grid gap-5 lg:grid-cols-[200px_minmax(0,1fr)] xl:gap-6">
