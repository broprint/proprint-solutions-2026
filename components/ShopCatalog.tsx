...
export function ShopCatalog({ products, initialCategory = 'All' }: { products: Product[]; initialCategory?: string }) {
  ...
  return <>
    ...
    <section className="py-10 xl:py-12"><div className="mx-auto w-[calc(100%-40px)] max-w-[1600px]"><div className="grid gap-5 lg:grid-cols-[210px_minmax(0,1fr)] xl:gap-6">
