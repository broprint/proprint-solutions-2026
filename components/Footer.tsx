...
export function Footer(){return <footer className="bg-[#061321] text-white">
  <div className="border-b border-white/10 bg-white/[.03]">
    <div className="container grid gap-4 py-6 sm:grid-cols-2 lg:grid-cols-4">
      <div className="flex gap-3"><MapPin className="mt-0.5 shrink-0 text-[#57a7ff]" size={18}/><div><b className="text-sm">Service Center</b><p className="mt-1 text-xs leading-5 text-slate-400">Dajeej, Kuwait</p></div></div>
      ...
      <div className="flex gap-3"><Mail className="mt-0.5 shrink-0 text-[#57a7ff]" size={18}/><div><b className="text-sm">Email Support</b><p className="mt-1 text-xs leading-5 text-slate-400">info@proprintsolutions.net</p></div></div>
      <div className="flex gap-3"><Clock3 className="mt-0.5 shrink-0 text-[#57a7ff]" size={18}/><div><b className="text-sm">Working Hours</b><p className="mt-1 text-xs leading-5 text-slate-400">Management demo — publish confirmed ProPrint timings before launch.</p></div></div>
    </div>
  </div>
  ...
  <div className="container grid gap-10 py-14 md:grid-cols-5">
    ...
    <div><h3 className="font-bold">Contact</h3><div className="mt-4 space-y-2 text-sm text-slate-300"><p>Dajeej, Kuwait</p><p>+965 24333201</p><p>info@proprintsolutions.net</p><Link className="inline-block pt-3 font-bold text-white" href="/contact">Contact ProPrint →</Link></div></div>
  </div>
